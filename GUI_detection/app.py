...
def main():
    ...
    # 将 lib/ 目录加入 sys.path, 以便 import detection_cpp
    ...
    app.setApplicationName("Radar Detection Suppression")
    ...
    if sys.platform == 'win32':
        try:
            ...
            ctypes.windll.shell32.SetCurrentProcessExplicitAppUserModelID("XDU_LJH.RadarDetectionSup")
        except Exception:
            pass
