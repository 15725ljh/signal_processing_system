...
def main():
    ...
    # 将 lib/ 目录加入 sys.path, 以便 import jamming_cpp
    ...
    app.setApplicationName("Radar Jamming Generation")
    ...
    if sys.platform == 'win32':
        try:
            ...
            ctypes.windll.shell32.SetCurrentProcessExplicitAppUserModelID("XDU_LJH.RadarJammingGen")
        except Exception:
            pass
    ...
    try:
        ...
        if not _pm.isNull():
            ...
            for _s in [16, 24, 32, 48, 64, 128, 256]:
                ...
                _p.drawText(QRectF(_cx - _bsz/2, _cy - _bsz/2, _bsz, _bsz), Qt.AlignmentFlag.AlignCenter, "02")
                _p.end()
                _icon.addPixmap(_sp)
