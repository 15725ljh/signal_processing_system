...
def main():
    ...
    # 将 lib/ 目录加入 sys.path, 以便 import signal_processing_cpp
    ...
    app.setApplicationName("Radar Signal Processing")
    ...
    if sys.platform == 'win32':
        try:
            ...
            ctypes.windll.shell32.SetCurrentProcessExplicitAppUserModelID("XDU_LJH.RadarSignalProcessing")
        except Exception:
            pass
